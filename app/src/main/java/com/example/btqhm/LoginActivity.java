...
public class LoginActivity extends AppCompatActivity {
    ...
    private void AllowUserToLogin() {
        ...
        if (TextUtils.isEmpty(password)){
            ...
            Toast.makeText(this, "Pleae Enter your Password", Toast.LENGTH_SHORT).show();
        }
        else{
                    ...
                    .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                           ...
                           loadingBar.dismiss();
                                ...
                                Toast.makeText(LoginActivity.this, "Error :"+massege, Toast.LENGTH_SHORT).show();
                            loadingBar.dismiss();
                            }
                        }
                    });
    ...
    private void init() {
        ...
        LoginButton = findViewById(R.id.loginButtn);
        PhoneButton = findViewById(R.id.phone_login_Buttn);
